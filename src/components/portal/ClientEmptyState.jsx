...
export default function ClientEmptyState({
  ...
  return (
    <div className={cn('ybs-empty flex flex-col items-center justify-center text-center', className)}>
      {Icon && (
      ...
      {description && (
        <p className="text-[14px] text-muted-foreground max-w-sm leading-relaxed mb-4">
          {description}
        </p>
      )}
