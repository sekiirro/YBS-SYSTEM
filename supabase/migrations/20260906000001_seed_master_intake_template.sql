...
BEGIN
  ...
  (v_template_id, 85, 'yes_no', 'مراجعة البيانات والإقرار', 'راجع إجاباتك قبل الإرسال. البيانات دي هتستخدم لمساعدة المدرب في بناء خطة التدريب والتغذية المناسبة لك. أؤكد أن المعلومات التي قدمتها صحيحة قدر الإمكان، وأنني سأبلغ المدرب عن أي حالة صحية أو إصابة أو قيود مهمة تؤثر على قدرتي على ممارسة النشاط البدني.', true, '{}', '{"section": "مراجعة البيانات"}'::jsonb);
